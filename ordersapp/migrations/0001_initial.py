...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0003_auto_20210322_1548'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'формируется'), ('STP', 'отправлен в обработку'), ('PRD', 'обработан'), ('PD', 'оплачен'), ('RDY', 'готов к выдаче'), ('CNC', 'отменён')], default='FM', max_length=3, verbose_name='статус')),
